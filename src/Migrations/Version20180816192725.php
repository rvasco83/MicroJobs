 ...
 */
final class Version20180816192725 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE categoria (id INT AUTO_INCREMENT NOT NULL, nome VARCHAR(100) NOT NULL, slug VARCHAR(100) NOT NULL, cadastro DATETIME NOT NULL, data_alteracao DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE servico (id INT AUTO_INCREMENT NOT NULL, usuario_id INT DEFAULT NULL, titulo VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, valor NUMERIC(10, 2) NOT NULL, descricao LONGTEXT NOT NULL, informacoes_adicionais LONGTEXT DEFAULT NULL, prazo_entrega INT NOT NULL, status VARCHAR(1) NOT NULL COMMENT \'Usar P para Publicado, A para em Análise, I para Inativo, E para Excluído e R para Rejeitado\', data_cadastro DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', data_alteracao DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', imagem VARCHAR(255) DEFAULT NULL, INDEX IDX_14873CCDB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
